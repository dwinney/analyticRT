...
#ifndef TRAJECTORY_FIT_HPP
#define TRAJECTORY_FIT_HPP
...
namespace analyticRT
{
    class trajectory_fitter : public fitter
    {
        ...
        trajectory_fitter(trajectory to_fit, std::string strategy, double tolerance = 1.E-6)
        ...
        // fit only real part
        inline void fit_imaginary(bool x){ _fit_imag = x; };

        protected:

        bool _fit_imag = false;
